...
export default function VehiclesPage() {
  ...
  const handleExport = async () => {
    try {
      ...
      // Create Excel manually from current data
              ...
              <tbody>
                {vehicles.map((v) => (
                  <tr key={v._id}>
                    ...
                    <td style={{ fontFamily: 'monospace', fontSize: '14px' }}>{v.licensePlate}</td>
                    <td>{v.brand || '-'}</td>
                    <td>{v.model || '-'}</td>
              ...
              <div className="detail-section">
                ...
                <div className="detail-grid">
                  ...
                  <div className="detail-item">
                    ...
                    <span className="detail-value" style={{ fontFamily: 'monospace', fontSize: '18px' }}>{selectedVehicle.licensePlate}</span>
                  </div>
                  <div className="detail-item">
